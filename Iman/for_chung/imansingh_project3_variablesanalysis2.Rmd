...
g + geom_point(aes(x=GrLivArea, color = OverallQual)) + scale_color_gradient(low = "firebrick4",space = OverallQual, high = "yellow") + theme_dark() + scale_y_continuous(name="Sale Price ($)", labels = scales::comma, breaks=seq(0,900000,100000))+xlab('Above Ground Living Area (sq.ft.)') + ggtitle("Sale Price vs Living Area (sq. ft.)")
